...
log_opts = [
    ...
    {
        "name": 'log_dir',
        "default": '/var/log/TestNovaCase',
        "help": 'the dir to store log file',
        "type": str,
    },
    {
        "name": 'log_file',
        "default": 'test_nova_case.log',
        "help": 'the file use to store log',
        "type": str,
    },
    {
        "name": 'log_format',
        "default": '%(asctime)s%(levelname)10s [%(name)s] %(filename)s(line:%(lineno)d) %(message)s',
...
options = get_options(log_opts, 'log')
